...
TaxGroupComponent.template = "addis_system_withholding.TaxGroupComponent";
...
export class TaxTotalsComponent extends Component {
    ...
    formatData(props) {
        ...
        console.log("TaxTotalsComponent.formatData", totals);
        ...
        for (let subtotal_title of totals.subtotals_order) {
            ...
            subtotals.push({
                'name': subtotal_title,
                'amount': amount_total,
                'taxable_amount_formatted': totals.taxable_amount_formatted,
                'nontaxable_amount_formatted': totals.non_taxable_amount_formatted,
...
TaxTotalsComponent.template = "addis_system_withholding.TaxTotalsField";
TaxTotalsComponent.components = { TaxGroupComponent };
TaxTotalsComponent.props = {
    ...standardFieldProps,
};

registry.category("fields").add("account-tax-totals-field-addis", TaxTotalsComponent);
